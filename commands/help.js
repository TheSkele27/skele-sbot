...
exports.run = async (client, message, args) => {
    ...
    .setColor(29848)
    .setDescription("Our help command is currently being majorly changed, in the meantime you may use our [website](http://www.theskele27.me) which has a list of current commands.")
